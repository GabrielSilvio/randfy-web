...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await apiClient.loginUser(validation.data, rememberMe);
      ...
      <div className="w-full lg:w-3/5 flex items-center justify-center p-8 bg-slate-50 md:bg-white">
        <div className="w-full max-w-md space-y-8 animate-slide-in-right">
          ...
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Boas-vindas de volta</h2>
            <p className="text-slate-500 mt-2">Acesse sua conta para gerenciar seus atendimentos.</p>
          </div>
